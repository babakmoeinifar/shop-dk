...
return array(
    ...
    */
    'attributes' => array(
        ...
        'confirmPwd' => 'تایید رمز عبور جدید',
        'currentPwd' => 'رمز عبور فعلی',
        'role_id' => 'نقش',
        'is_active' => 'وضعیت',
        'nationalcode' => 'کد ملی',
        'discount_model' => 'مدل تخفیف',
        'percent' => 'درصد تخفیف',
        'buy_quantity' => 'تعداد خرید',
        'prize_quantity' => 'تعداد جایزه',
        'prize_name' => 'نام جایزه',
        'floor_buy' => 'حداقل خرید',
        'ceil_buy' => 'حداکثر خرید',
